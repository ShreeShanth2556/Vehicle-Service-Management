...
EMAIL_RECEIVING_USER = ['educate870@gmail.com'] # email on which you will receive messages sent from website

RAZORPAY_KEY_ID = "rzp_test_RfXFBHOMZRj1ad"
RAZORPAY_KEY_SECRET = "oRJwwfWMNPnjUk8AdDGvk8JR"
